...
<body>
	...
	<table class="table table-striped table-bordered table-condensed table-hover table-fixed-header">
		<thead class="header">
			<tr>
				<th>流程分类</th>
				<th>流程标识</th>
				...
				<th>流程XML</th>
				<th>流程图片</th>
				<th style="min-width:100px;">部署时间</th>
				<th>流程ID</th>
			</tr>
		</thead>
		<tbody>
			<c:forEach items="${page.list}" var="object">
				...
				<tr>
					...
					</td><td><a target="_blank" href="${ctx}/act/process/resource/read?procDefId=${process.id}&resType=xml">${process.resourceName}</a></td>
