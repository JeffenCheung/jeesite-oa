...
<body>
	...
	<form:form id="inputForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<span class="help-inline"><font color="red">*</font> Markdown实时在线编辑器。<i>Markdown editor is a WYSIWYG editor.</i></span>
				<form:textarea id="content" path="content" htmlEscape="false" rows="10" maxlength="2000" data-provide="markdown" class="input-xxlarge required"/>
			</div>
		</div>
